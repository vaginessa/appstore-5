details:
  ...
  category: Blogging
  version: 4.0.1
  logo: http://s.adamcooke.io/14/IeFQJ.png
  description: |
    WordPress is a sophisticated blogging & CMS engine. When deployed on Viaduct it offers
    you a scaleable and easy to use way of starting your own blog.
